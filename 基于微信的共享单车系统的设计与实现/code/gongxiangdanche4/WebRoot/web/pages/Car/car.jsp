    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '身份证', width: 100, field: 'title', sortable: true},
                {title: '备注', width: 400, field: 'note',sortable: true},
                {title: '到达时间', width: 100, field: 'intime',sortable: true}
            ]
        ], toolbar: [
            {
                text: '新增',
...
function deleteItem(uuid) {
    openBackGround();
    $.post("<%=__APP__%>/Car!deleteItem", {id: uuid}, function (data) {
        closeBackGround();
        closeFlush();
    });
}
...
<div id="managerDialog" class="easyui-dialog" title="停车管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                <th width="30%" align="right"><label>身份证：</label></th>
                <td width="60%" colspan="1">
                    <input id="name" name="car.title" class="easyui-validatebox"
...
<!--              <tr>
                ...
                <td width="60%" colspan="1">
                    <select id="typecn" name="car.type">
                    	<option value="" selected="selected">大型</option>
            ...
            <tr>
                <th width="30%" align="right"><label>到达时间：</label></th>
                <td width="60%" colspan="1">
                    <input id="intime" name="car.intime" class="easyui-datetimebox"
                           style="width:300px;word-wrap: break-word;word-break:break-all;" type="text" required="true"
                           validType="length[0,100]"/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="1" width="60%">
                    <textarea style="width:300px;height: 100px;" id="note" name="car.note"></textarea>
                </td>
            </tr>
        </table>
