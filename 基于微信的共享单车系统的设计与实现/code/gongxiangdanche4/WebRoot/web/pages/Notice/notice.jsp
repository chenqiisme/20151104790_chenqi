...
<div id="managerDialog" class="easyui-dialog" title="公告管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
			...
			<!-- <tr>
                <th width="30%" align="right"><label>公告图片：</label></th>
                <td colspan="" width="30%">
            ...
            <%-- <tr>
                <th width="30%" align="right"><label>种类：</label></th>
                <td width="60%" colspan="1">
                    <select id="typecn" name="notice.type">
                    	<option value="1" selected="selected">景点公告</option>
