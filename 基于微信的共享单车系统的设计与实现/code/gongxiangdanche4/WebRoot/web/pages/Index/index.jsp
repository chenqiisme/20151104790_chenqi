...
<head id="Head1">
    ...
    if(roletype == "1"){
    	_menus = {
   	         "menus": [
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "网点管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "网点列表", "icon": "icon-database", "url": "<%= __APP__%>/Park!park"}
   	                 ]},
   	              {"menuid": "1", "icon": "icon-magic", "menuname": "反馈管理",
   		                 "menus": [
   		                     {"menuid": "12", "menuname": "反馈列表", "icon": "icon-database", "url": "<%= __APP__%>/Replay!replay"}
   		                 ]},
   		              {"menuid": "1", "icon": "icon-magic", "menuname": "公告通知管理",
   	   		                 "menus": [
   	   		                     {"menuid": "12", "menuname": "公告通知列表", "icon": "icon-database", "url": "<%= __APP__%>/Notice!notice"}
   	   		                 ]},
   	            {"menuid": "1", "icon": "icon-magic", "menuname": "使用记录",
   		                 "menus": [
   		                     {"menuid": "12", "menuname": "记录列表", "icon": "icon-database", "url": "<%= __APP__%>/Dingzuo!dingzuo"}
   		                 ]},
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "地区管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "地区列表", "icon": "icon-database", "url": "<%= __APP__%>/Park!type"}
   	                 ]},
//   	              {"menuid": "1", "icon": "icon-magic", "menuname": "推送管理",
//   	   	                 "menus": [
//   	   	                     {"menuid": "12", "menuname": "通知推送列表", "icon": "icon-database", "url": "<%= __APP__%>/Message!message"}
//   	   	                 ]},
    	...
    	_menus = {
   	         "menus": [
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "停车管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "停车列表", "icon": "icon-database", "url": "<%= __APP__%>/Car!car"}
   	                 ]}
   	         ]};
    }
