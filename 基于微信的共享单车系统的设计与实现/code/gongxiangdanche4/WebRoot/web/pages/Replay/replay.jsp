...
$(function () {
    $('#grid1').datagrid({
        ...
        striped: true,
        fit: true,
        url: "<%=__APP__%>/Replay!getList?pid=10000",
        idField: 'id',
        pagination: true,
        rownumbers: true,
        pageSize: 10,
        ...
        columns: [
            [
                ...
                {title: '意见', width: 100, field: 'note', sortable: true},
                {title: '日期', width: 100, field: 'ndate', sortable: true},
                {title: '用户', width: 100, field: 'username', sortable: true}
            ]
        ]
         , toolbar: [
            /* {
