...
function deleteItem(uuid) {
    openBackGround();
    $.post("<%=__APP__%>/Message!deleteItem", {id: uuid}, function (data) {
        closeBackGround();
        closeFlush();
    });
}
...
<div id="managerDialog" class="easyui-dialog" title="通知管理" style="width:450px;height:250px;" toolbar="#dlg-toolbar"
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                ...
                <td width="60%" colspan="1">
                    <input id="name" name="message.title" class="easyui-validatebox"
...
<%--             <tr>
                ...
                <td width="60%" colspan="1">
                    <select id="typecn" name="message.type">
            ...
            <tr>
                ...
                <td colspan="1" width="60%">
                    <textarea style="width:300px;height: 100px;" id="note" name="message.note"></textarea>
                </td>
            </tr>
        </table>
