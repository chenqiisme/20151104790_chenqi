...
function myinfo(){
    ...
    if(!userinfo.money || userinfo.money=='undefined'){
        money = 0;
    }
    $("#vmoney").text("余额:"+money || 0);
    $("#rmyImage3").attr("src",fileurl+userinfo.img);
}
...
function charge(){
    var money = $("#money").val();
    ajaxCallback("charge",{id:userinfo.id,money:money},function(data){
        userinfo = data;
...
function toMyMoney(){
    ...
    $("#lingqian").text(userinfo.money+"元");
}
